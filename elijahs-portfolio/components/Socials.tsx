...
export function Socials () {
  ...
  return(
    <div className="absolute right-10 z-50 flex flex-row justify-between select-none rounded-2xl cursor-pointer border-3 bg-gradient-to-r from-purphaze to-DS2MidPink transition-all duration-200 ease-in-out" onClick={() => SetDrop(!drop)}>
      {drop ? (
        <div className="grid grid-cols-7 gap-x-5 justify-between content-center bg-black p-2" >
          ...
          <div className="order-first bg-gradient-to-r from-purphaze to-DS2MidPink rounded-2xl content-center">
